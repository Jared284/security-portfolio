...
- implement automated detection logic
- enforce defensive controls (Fail2Ban)
...
- Observed real SSH brute-force attempts against exposed server
- Detected repeated failed login attempts via authentication logs
- Automatically banned malicious IP: 128.6.147.18
- Validated detection and response using fail2ban-client
